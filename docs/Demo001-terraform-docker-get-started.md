...
docker_image.nginx: Creation complete after 49s [id=sha256:55f4b40fe486a5b734b46bb7bf28f52fa31426bf23be068c8e7b19e58d9b8debnginx:latest]
docker_container.nginx: Creating...
docker_container.nginx: Creation complete after 1s [id=08d4429d03efd54d55c6eb177443970cd4c98a215e6161a0376327bac94c1118]
...
08d4429d03ef   55f4b40fe486   "/docker-entrypoint.…"   2 minutes ago   Up 2 minutes   0.0.0.0:8000->80/tcp   tutorial
```
### terraform show
```
[c7-master:root:~/learn-terraform-docker-container] # terraform show
...
resource "docker_container" "nginx" {
    ...
    env               = []
    gateway           = "172.17.0.1"
    hostname          = "08d4429d03ef"
    id                = "08d4429d03efd54d55c6eb177443970cd4c98a215e6161a0376327bac94c1118"
...
```
[c7-master:root:~/learn-terraform-docker-container] # terraform state list
docker_container.nginx
docker_image.nginx
```
